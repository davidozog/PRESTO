...
badd +1 ~/School/MATLAByrinth/src/MATLAByrinth/MATLAByrinth.py
badd +1 ~/School/MATLAByrinth/src/myfunc.m
badd +1 ~/School/MATLAByrinth/src/matlab/send_jobs_to_workers.m
badd +1 ~/School/MATLAByrinth/TODO.txt
badd +1 ~/School/MATLAByrinth/src/matlab/mworker.m
badd +0 ~/School/MATLAByrinth/src/matlab/Rinth_testfunc.m
...
exe 'vert 1resize ' . ((&columns * 65 + 98) / 197)
exe '2resize ' . ((&lines * 22 + 24) / 49)
exe 'vert 2resize ' . ((&columns * 65 + 98) / 197)
exe '3resize ' . ((&lines * 24 + 24) / 49)
exe 'vert 3resize ' . ((&columns * 65 + 98) / 197)
exe '4resize ' . ((&lines * 22 + 24) / 49)
exe 'vert 4resize ' . ((&columns * 65 + 98) / 197)
exe '5resize ' . ((&lines * 24 + 24) / 49)
exe 'vert 5resize ' . ((&columns * 65 + 98) / 197)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
edit ~/School/MATLAByrinth/src/matlab/Rinth_testfunc.m
setlocal keymap=
setlocal noarabic
